<?php
// Default (original) copy of the privacy policy page, used until it is edited
// in the admin (Stránky → Ochrana osobních údajů).

return [
  'hero_title'    => 'Zásady ochrany osobních údajů',
  'hero_title_en' => 'Privacy Policy',
  'hero_title_de' => 'Datenschutzbestimmungen',
  'hero_desc'     => 'Informace o zpracování osobních údajů podle čl. 13 nařízení GDPR.',
  'hero_desc_en'  => 'Information on the processing of personal data pursuant to Article 13 of the GDPR.',
  'hero_desc_de'  => 'Informationen zur Verarbeitung personenbezogener Daten gemäß Art. 13 DSGVO.',
...
<p style="color:var(--text-muted);font-size:.85rem;">Poslední aktualizace: září 2026</p>
PRIVACY_HTML,
  'content_en' => <<<'PRIVACY_HTML'
...
<p style="color:var(--text-muted);font-size:.85rem;">Last updated: September 2026</p>
PRIVACY_HTML,
  'content_de' => <<<'PRIVACY_HTML'
...
<p style="color:var(--text-muted);font-size:.85rem;">Letzte Aktualisierung: September 2026</p>
PRIVACY_HTML,
];
